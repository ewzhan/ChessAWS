...
<body>
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="staff-index.php" class="logo d-flex align-items-center me-auto">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="staff-event.php">Event</a></li>
          <li><a href="staff-forum.php">Forum</a></li>
          <li><a href="staff-repository.php">Game Repository</a></li>
          ...
          <li class="dropdown has-dropdown"><a href="#"><img src="../assets/img/profile.webp" id="profileImg"></a>
            <ul>
                <li><a href="../staff/staff-users.php">User Management</a></li>
                <form method="POST">
